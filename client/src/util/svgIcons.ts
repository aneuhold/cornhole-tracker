import { satisfiesRecord } from './typeUtils';
...
/**
 * A bunch of svg paths retrieved from various places.
 *
 ...
 * object. Only use the path, then set the viewBox to whatever the width and
 * height were.
 */
const svgIcons = satisfiesRecord<SvgIconInfo>()({
  twitter: {
    path: `<path
    fill="currentColor"
